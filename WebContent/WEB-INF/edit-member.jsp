									...
									<form action="edit-member" method="post" class="">
										...
										<div class="form-group">
											<label for="email">Adresse Email</label> <input name="email"
												type="email" class="input-lg form-control" id="email"
												value="${member.email}">
										</div>
										<div class="form-group">
											<label for="birthdate">Date d'anniversaire</label> <input
												id="birthdate" name="birthdate" type="text"
												class="input-lg form-control" value="${member.birthdate}">
										</div>
											...
											<label for="promotion">Promotion</label> <select
												...
												<c:forEach items="${promotions}" var="promotion">
													<option value="${promotion.name}"
														${promotion.name == member.promotion.name ? 'selected' : ''}>${promotion.name}</option>
												</c:forEach>
											</select>
										</div>
